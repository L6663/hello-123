...
_REQUIRED_FILES = (
    ...
    "docs/STAGE8_R6_LEARNING_PANORAMA.md",
    "docs/STAGE8_R7_LEARNING_IDENTITY_AND_SCOPE.md",
    "docs/STAGE8_FINAL_PRODUCTIZATION_ACCEPTANCE.md",
    "schemas/learning-project-report.schema.json",
    "schemas/learning-query-packet.schema.json",
    "schemas/model-learning-observation.schema.json",
